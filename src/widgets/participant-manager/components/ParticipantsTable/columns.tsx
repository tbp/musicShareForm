...
// Компонент для ячейки с долей авторских прав
function CopyrightShareCell({ 
  participant, 
  index, 
  onUpdate 
}: { 
...
// Компонент для ячейки с долей смежных прав
function RelatedRightsShareCell({ 
  participant, 
  index, 
  onUpdate 
}: { 
